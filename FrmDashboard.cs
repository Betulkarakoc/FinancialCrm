...
namespace FinancialCrm
{
    public partial class FrmDashboard : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (count % 4 == 1)
            {
                var elektrikFaturasi = db.Bills
                    .Where(x => x.BillTitle == "Elektrik Faturası")
                    .Select(y => y.BillAmount)
                    .FirstOrDefault();
            ...
            if (count % 4 == 0)
            {
                var internetFaturasi = db.Bills
                    .Where(x => x.BillTitle == "İnternet Faturası")
                    .Select(y => y.BillAmount)
                    .FirstOrDefault();
